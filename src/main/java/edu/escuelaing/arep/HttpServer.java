            ...
            while ((inputLine = in.readLine()) != null) {
                ...
                if (file.startsWith("/clima")){
                    outputLine = "HTTP/1.1 200 OK\r\n"
                            ...
                            + "</head>"
                            + "<body>"
                            + "<h1>Consulta el clima en segundos </h1>"
                            + "<p>Ingresa el nombre de la ciudad que deseas consultar</p>"
                            +"<input type='text' class='form-control' placeholder='Ciudad' name='ciudad' id='ciudad'  ><br></br>"
